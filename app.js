...
// ── из PDF: bu/bunu/buna ──
{"ru": "Что это?", "tr": "Bu ne?", "hint": "bu — без падежа (именительный)", "level": 1},
{"ru": "Кто это?", "tr": "Bu kim?", "hint": "bu — без падежа (именительный)", "level": 1},
{"ru": "Это стол.", "tr": "Bu masa.", "hint": "bu — без падежа", "level": 1},
{"ru": "Это Али.", "tr": "Bu Ali.", "hint": "bu — без падежа", "level": 1},
{"ru": "Мама — адвокат?", "tr": "Anne avukat mı?", "hint": "вопрос с mı/mi", "level": 1},
{"ru": "Да, мама — адвокат.", "tr": "Evet, anne avukat.", "hint": "утвердительный ответ", "level": 1},
{"ru": "Нет, не адвокат.", "tr": "Hayır, değil.", "hint": "отрицательный ответ (değil)", "level": 1},
{"ru": "Можно взять это?", "tr": "Bunu alabilir miyim?", "hint": "bunu — вин. от bu; al+a+bil+ir+mi+y+im", "level": 1},
{"ru": "Можно посмотреть это?", "tr": "Buna bakabilir miyim?", "hint": "buna — дат. от bu; bak+a+bil+ir+mi+y+im", "level": 1},
{"ru": "Можно взять этот товар?", "tr": "Bu ürünü alabilir miyim?", "hint": "bu ürünü — вин. к ürün (есть сущ., bu без падежа)", "level": 1},
{"ru": "Можно взять это лекарство?", "tr": "Bu ilacı alabilir miyim?", "hint": "bu ilacı — вин. к ilaç (ilaç→ilac+ı)", "level": 1},
{"ru": "Можно посмотреть этот товар?", "tr": "Bu ürüne bakabilir miyim?", "hint": "bu ürüne — дат. к ürün", "level": 1},
{"ru": "Вчера я видел Ахмета.", "tr": "Dün Ahmet'i gördüm.", "hint": "винительный конкретного имени (Ahmet+i)", "level": 1},
{"ru": "Я очень люблю Стамбул.", "tr": "İstanbul'u çok seviyorum.", "hint": "винительный города (İstanbul+u)", "level": 1},
{"ru": "Я хочу эту книгу.", "tr": "Bu kitabı istiyorum.", "hint": "bu kitabı — вин. к kitap; bu без суф. (есть сущ.)", "level": 1},
{"ru": "Я знаю этого человека.", "tr": "Bu adamı tanıyorum.", "hint": "bu adamı — вин. к adam", "level": 1},
{"ru": "Он читает книгу (какую-то).", "tr": "O bir kitap okuyor.", "hint": "bir = неопределённый артикль; без вин. суффикса", "level": 1},
{"ru": "Я вижу тебя.", "tr": "Seni görüyorum.", "hint": "вин. от sen (ты)", "level": 1},
{"ru": "Я жду папу.", "tr": "Babanı bekliyorum.", "hint": "вин. с притяж. суффиксом -nı (твой папа)", "level": 2},
{"ru": "Я видел своих друзей.", "tr": "Arkadaşlarını gördüm.", "hint": "вин. мн.ч. с притяж. суффиксом -nı", "level": 2},
{"ru": "Мне дай воды.", "tr": "Bana su ver.", "hint": "bana — дат. от ben (я)", "level": 1},
{"ru": "Дай ему.", "tr": "Ona ver.", "hint": "ona — дат. от o (он/она/оно)", "level": 1},
{"ru": "Мы идём к ним.", "tr": "Onlara gidiyoruz.", "hint": "onlara — дат. от onlar (они)", "level": 1}];
...
// ═══ ИЗ ФАЙЛА 7: Это дорого (базовые вопросы) ═══
  {topic:'покупки', q_ru:'Это дорого?', q_tr:'Bu pahalı mı?', a_tr:'Hayır, bu pahalı değil.', hint:'pahalı = дорогой, değil = не'},
  {topic:'покупки', q_ru:'Это дёшево?', q_tr:'Bu ucuz mu?', a_tr:'Hayır, bu ucuz değil.', hint:'ucuz = дешёвый'},
  {topic:'покупки', q_ru:'Что это?', q_tr:'Bu ne?', a_tr:'Bu meyveler.', hint:'meyveler = фрукты'},
  {topic:'покупки', q_ru:'Они дорогие?', q_tr:'Onlar pahalı mı?', a_tr:'Hayır, onlar pahalı değil.', hint:'onlar = они'},
  {topic:'покупки', q_ru:'Это твой товар?', q_tr:'Bu senin malın mı?', a_tr:'Hayır, bu benim malım değil.', hint:'mal = товар, senin = твой'},
  {topic:'покупки', q_ru:'Это его товар?', q_tr:'Bu onun malı mı?', a_tr:'Hayır, bu onun malı değil.', hint:'onun = его/её'},
  {topic:'покупки', q_ru:'Это ваша машина?', q_tr:'Bu sizin arabanız mı?', a_tr:'Hayır, bu bizim arabamız değil.', hint:'sizin = ваш, bizim = наш'},
  {topic:'покупки', q_ru:'У вас есть машина?', q_tr:'Sizin arabanız var mı?', a_tr:'Hayır, bizim arabamız yok.', hint:'var = есть, yok = нет'},
  {topic:'покупки', q_ru:'У него есть машина?', q_tr:'Onun arabası var mı?', a_tr:'Evet, bu onun arabası.', hint:'onun arabası = его машина'},
  {topic:'покупки', q_ru:'Его машина дорогая?', q_tr:'Onun arabası pahalı mı?', a_tr:'Hayır, onun arabası ucuz.', hint:'pahalı = дорогая'},
  {topic:'покупки', q_ru:'У тебя есть квартира?', q_tr:'Senin dairen var mı?', a_tr:'Hayır, benim kiralık dairem var.', hint:'kiralık = съёмная'},
  {topic:'покупки', q_ru:'У тебя есть работа?', q_tr:'Senin işin var mı?', a_tr:'Benim işim yok.', hint:'iş = работа, yok = нет'},
  {topic:'покупки', q_ru:'Это ваши документы?', q_tr:'Bu sizin evraklarınız mı?', a_tr:'Bizim evraklarımız yok.', hint:'evraklar = документы'},
  {topic:'покупки', q_ru:'Кто ваш муж?', q_tr:'Sizin kocanız kim?', a_tr:'Benim kocam Anton.', hint:'koca = муж, kim = кто'},
  {topic:'покупки', q_ru:'Лена ваша жена?', q_tr:'Lena sizin karınız mı?', a_tr:'O benim kız kardeşim.', hint:'kız kardeş = сестра'},

  // ═══ ИЗ ФАЙЛА 9: Добро пожаловать (кафе) ═══
  {topic:'кафе', q_ru:'Добро пожаловать', q_tr:'Hoş geldiniz', a_tr:'Hoş bulduk', hint:'стандартное приветствие в Турции'},
  {topic:'кафе', q_ru:'Вам нужен свободный столик?', q_tr:'Sizde boş masa lazım mı?', a_tr:'Evet, bize boş masa lazım.', hint:'boş = свободный, masa = стол'},
  {topic:'кафе', q_ru:'Насколько человек нужен столик?', q_tr:'Kaç kişilik boş masa lazım?', a_tr:'Bize üç kişilik boş masa lazım.', hint:'kaç kişilik = на сколько человек'},
  {topic:'кафе', q_ru:'Этот столик свободный?', q_tr:'Bu masa boş mu?', a_tr:'Hayır, bu masa boş değil.', hint:'boş = свободный'},
  {topic:'кафе', q_ru:'У вас есть меню?', q_tr:'Sizde menü var mı?', a_tr:'Evet, bir dakika.', hint:'bir dakika = одну минуту'},
  {topic:'кафе', q_ru:'Можете дать нам меню?', q_tr:'Bize menü verebilir misiniz?', a_tr:'Tabii, buyurun.', hint:'verebilir misiniz = можете дать'},
  {topic:'кафе', q_ru:'Можете дать меню моей супруге?', q_tr:'Eşime menü verebilir misiniz?', a_tr:'Tabii efendim.', hint:'eşim = моя супруга/супруг'},
  {topic:'кафе', q_ru:'У вас есть завтрак?', q_tr:'Sizde kahvaltı var mı?', a_tr:'Evet, kahvaltı var.', hint:'kahvaltı = завтрак'},
  {topic:'кафе', q_ru:'Сколько у вас стоит завтрак?', q_tr:'Sizde kahvaltı ne kadar?', a_tr:'Yüz elli lira.', hint:'ne kadar = сколько стоит'},
  {topic:'кафе', q_ru:'Вам нужен завтрак?', q_tr:'Size kahvaltı lazım mı?', a_tr:'Evet, kahvaltı istiyorum.', hint:'lazım = нужен'},
  {topic:'кафе', q_ru:'Могу ли я сесть за этот столик?', q_tr:'Bu masaya oturabilir miyim?', a_tr:'Evet, buyurun.', hint:'oturabilir miyim = могу я сесть'},
  {topic:'кафе', q_ru:'Я хочу заказать это блюдо.', q_tr:'Bu yemeği sipariş etmek istiyorum.', a_tr:'Tabii efendim.', hint:'sipariş etmek = заказать, yemek = блюдо'},
  {topic:'кафе', q_ru:'Я хочу попробовать этот салат.', q_tr:'Bu salatayı tatmak istiyorum.', a_tr:'Buyurun.', hint:'tatmak = попробовать, salata = салат'},
  {topic:'кафе', q_ru:'Мне нравится это блюдо.', q_tr:'Bu yemeği beğeniyorum.', a_tr:'Çok memnun oldum.', hint:'beğenmek = нравиться, оценивать'},
  {topic:'кафе', q_ru:'Мне нужно попробовать это.', q_tr:'Bunu tatmam lazım.', a_tr:'Tabii.', hint:'tatmam lazım = мне нужно попробовать'},

  // ═══ ИЗ ФАЙЛА 10: Добро пожаловать (магазин) ═══
  {topic:'магазин', q_ru:'У вас есть такая вещь?', q_tr:'Sizde böyle bir şey var mı?', a_tr:'Evet, var.', hint:'böyle bir şey = такая вещь'},
  {topic:'магазин', q_ru:'Сколько стоит такая вещь?', q_tr:'Böyle bir şey sizde ne kadar?', a_tr:'Yüz lira.', hint:'ne kadar = сколько стоит'},
  {topic:'магазин', q_ru:'Как называется такая вещь?', q_tr:'Sizde böyle bir şeyin adı ne?', a_tr:'Bilmiyorum.', hint:'adı ne = как называется'},
  {topic:'магазин', q_ru:'Вам нужна такая вещь?', q_tr:'Size böyle bir şey lazım mı?', a_tr:'Evet, lazım.', hint:'lazım = нужен/нужна'},
  {topic:'магазин', q_ru:'Нам такая вещь не нужна.', q_tr:'Bize böyle bir şey lazım değil.', a_tr:'Anladım.', hint:'lazım değil = не нужна'},
  {topic:'магазин', q_ru:'Я хочу такую вещь.', q_tr:'Ben böyle bir şey istiyorum.', a_tr:'Buyurun.', hint:'istiyorum = хочу'},
  {topic:'магазин', q_ru:'У вас есть такое лекарство?', q_tr:'Sizde böyle bir ilaç var mı?', a_tr:'Evet, var.', hint:'ilaç = лекарство'},
  {topic:'магазин', q_ru:'Сколько стоит такое лекарство?', q_tr:'Böyle bir ilaç sizde ne kadar?', a_tr:'İki yüz lira.', hint:'ne kadar = сколько'},
  {topic:'магазин', q_ru:'Вам нужно такое лекарство?', q_tr:'Size böyle bir ilaç lazım mı?', a_tr:'Evet, lazım.', hint:'lazım = нужно'},

  // ═══ ИЗ ФАЙЛА 14: türkçe böyle bir şey (тур. → рус.) ═══
  {topic:'магазин', q_ru:'Hoş geldiniz.', q_tr:'Добро пожаловать.', a_tr:'Hoş bulduk.', hint:'ответ на приветствие'},
  {topic:'магазин', q_ru:'Türkçeyi kötü biliyorum, ama biraz konuşabilirim.', q_tr:'Я плохо знаю турецкий, но могу немного говорить.', a_tr:'Anlıyorum.', hint:'kötü biliyorum = плохо знаю'},
  {topic:'магазин', q_ru:'Yavaş konuşabilir misiniz?', q_tr:'Вы можете говорить медленно?', a_tr:'Tabii efendim.', hint:'yavaş = медленно'},
  {topic:'магазин', q_ru:'Soru sorabilir miyim?', q_tr:'Могу я задать вопрос?', a_tr:'Tabii.', hint:'soru sormak = задавать вопрос'},
  {topic:'магазин', q_ru:'Ben sizi anlamıyorum.', q_tr:'Я вас не понимаю.', a_tr:'Özür dilerim.', hint:'anlamıyorum = не понимаю'},
  {topic:'магазин', q_ru:'Sizde böyle bir şey var mı?', q_tr:'У вас есть такая вещь?', a_tr:'Evet, var.', hint:'böyle bir şey = такая вещь'},
  {topic:'магазин', q_ru:'Sizde böyle bir şeyin fiyatı ne kadar?', q_tr:'Сколько у вас стоит такая вещь?', a_tr:'Yüz lira.', hint:'fiyat = цена'},
  {topic:'магазин', q_ru:'Ben böyle bir şey istiyorum.', q_tr:'Я хочу такую вещь.', a_tr:'Buyurun.', hint:'istiyorum = хочу'},
  {topic:'магазин', q_ru:'Sizde böyle bir ilaç var mı?', q_tr:'У вас есть такое лекарство?', a_tr:'Evet, var.', hint:'ilaç = лекарство'},
  {topic:'магазин', q_ru:'Ben böyle bir ilaç istiyorum.', q_tr:'Я хочу такое лекарство.', a_tr:'Buyurun.', hint:'ilaç = лекарство'},

  // ═══ ИЗ ФАЙЛА 15: купить/оплатить ═══
  {topic:'покупки', q_ru:'Я хочу купить эту.', q_tr:'Bunu satın almak istiyorum.', a_tr:'Buyurun efendim.', hint:'satın almak = купить, bunu = это (вин.)'},
  {topic:'покупки', q_ru:'Мне нужно купить эту.', q_tr:'Bunu almam lazım.', a_tr:'Tabii.', hint:'almam lazım = мне нужно купить'},
  {topic:'покупки', q_ru:'Я хочу купить эту вещь тебе.', q_tr:'Bu şeyi sana satın almak istiyorum.', a_tr:'Teşekkür ederim.', hint:'sana = тебе (дат.)'},
  {topic:'покупки', q_ru:'Я хочу купить одежду.', q_tr:'Kıyafet satın almak istiyorum.', a_tr:'Buyurun.', hint:'kıyafet = одежда'},
  {topic:'покупки', q_ru:'Мне нужно купить эту одежду ей.', q_tr:'Bu kıyafeti ona almam lazım.', a_tr:'Anladım.', hint:'ona = ей (дат.), bu kıyafeti = эту одежду (вин.)'},
  {topic:'покупки', q_ru:'Я хочу оплатить это.', q_tr:'Bunu ödemek istiyorum.', a_tr:'Nakit mi kart mı?', hint:'ödemek = платить'},
  {topic:'покупки', q_ru:'Мне нужно это оплатить.', q_tr:'Bunu ödemem gerekiyor.', a_tr:'Buyurun.', hint:'ödemem gerekiyor = мне нужно оплатить'},

  // ═══ ИЗ ФАЙЛА 16: alabilir miyim / bakabilir miyim ═══
  {topic:'покупки', q_ru:'Могу я это купить?', q_tr:'Bunu alabilir miyim?', a_tr:'Evet, buyurun.', hint:'alabilir miyim = могу ли я взять/купить'},
  {topic:'покупки', q_ru:'Могу купить эту вещь?', q_tr:'Bu şeyi alabilir miyim?', a_tr:'Tabii.', hint:'bu şeyi = эту вещь (вин.)'},
  {topic:'покупки', q_ru:'Могу взять чек?', q_tr:'Fişi alabilir miyim?', a_tr:'Evet, buyurun.', hint:'fiş = чек'},
  {topic:'покупки', q_ru:'Могу взять сдачу?', q_tr:'Üstünü alabilir miyim?', a_tr:'Tabii.', hint:'üstü = сдача'},
  {topic:'покупки', q_ru:'За сколько я могу это купить?', q_tr:'Bunu kaça alabilirim?', a_tr:'Yüz elli liraya.', hint:'kaça = за сколько'},
  {topic:'покупки', q_ru:'Могу я купить это со скидкой?', q_tr:'Bunu indirimli alabilir miyim?', a_tr:'Hayır, indirim yok.', hint:'indirim = скидка'},
  {topic:'покупки', q_ru:'Могу я это оплатить?', q_tr:'Bunu ödeyebilir miyim?', a_tr:'Evet, buyurun.', hint:'ödeyebilir miyim = могу ли я оплатить'},
  {topic:'покупки', q_ru:'Могу я оплатить наличными?', q_tr:'Bunu nakit ödeyebilir miyim?', a_tr:'Evet, nakit olur.', hint:'nakit = наличные'},
  {topic:'покупки', q_ru:'Могу я оплатить картой?', q_tr:'Bunu kartla ödeyebilir miyim?', a_tr:'Evet, kart geçiyor.', hint:'kart = карта'},
  {topic:'покупки', q_ru:'Могу я посмотреть на это?', q_tr:'Buna bakabilir miyim?', a_tr:'Tabii, buyurun.', hint:'buna = на это (дат.), bakabilir miyim = могу посмотреть'},
  {topic:'покупки', q_ru:'Могу я посмотреть на эту вещь?', q_tr:'Bu şeye bakabilir miyim?', a_tr:'Evet, buyurun.', hint:'bu şeye = на эту вещь (дат.)'},
  {topic:'покупки', q_ru:'Могу я посмотреть чек?', q_tr:'Fişe bakabilir miyim?', a_tr:'Buyurun.', hint:'fişe = на чек (дат.)'},
  {topic:'покупки', q_ru:'Могу я посмотреть лекарство?', q_tr:'İlaca bakabilir miyim?', a_tr:'Buyurun.', hint:'ilaca = на лекарство (дат.)'},

  // ═══ ИЗ ФАЙЛА 1: Это дом (притяжательные) ═══
  {topic:'дом и семья', q_ru:'Это дом?', q_tr:'Bu ev mi?', a_tr:'Hayır, burası ev değil.', hint:'ev = дом, değil = не'},
  {topic:'дом и семья', q_ru:'Это квартира?', q_tr:'Bu daire mi?', a_tr:'Hayır, burası ofis.', hint:'daire = квартира, ofis = офис'},
  {topic:'дом и семья', q_ru:'Это твоя машина?', q_tr:'Bu senin araban mı?', a_tr:'Hayır, bu onun arabası.', hint:'senin araban = твоя машина'},
  {topic:'дом и семья', q_ru:'Эта книга интересная?', q_tr:'Bu kitap enteresan mı?', a_tr:'Hayır, o sıkıcı.', hint:'enteresan = интересный, sıkıcı = скучный'},
  {topic:'дом и семья', q_ru:'Это твои документы?', q_tr:'Bu senin evrakların mı?', a_tr:'Hayır, bu onun evrakları.', hint:'evraklar = документы'},
  {topic:'дом и семья', q_ru:'У тебя есть гражданство?', q_tr:'Senin vatandaşlığın var mı?', a_tr:'Evet, benim vatandaşlığım var.', hint:'vatandaşlık = гражданство'},
  {topic:'дом и семья', q_ru:'Это ваша семья?', q_tr:'Bu sizin aileniz mi?', a_tr:'Evet, bu bizim ailemiz.', hint:'aile = семья'},
  {topic:'дом и семья', q_ru:'Это его дети?', q_tr:'Bu onun çocukları mı?', a_tr:'Hayır, bu bizim çocuklarımız.', hint:'çocuklar = дети'},
  {topic:'дом и семья', q_ru:'Это новая одежда?', q_tr:'Bu yeni kıyafet mi?', a_tr:'Hayır, o eski.', hint:'yeni = новый, eski = старый'},
  {topic:'дом и семья', q_ru:'Эти фрукты дорогие?', q_tr:'Bu meyveler pahalı mı?', a_tr:'Hayır, onlar ucuz.', hint:'meyveler = фрукты, ucuz = дешёвые'},
  {topic:'дом и семья', q_ru:'У неё есть муж?', q_tr:'Onun kocası var mı?', a_tr:'Evet, onun kocası Ivan.', hint:'koca = муж'},
  {topic:'дом и семья', q_ru:'Это ваша сумка?', q_tr:'Bu sizin çantanız mı?', a_tr:'Hayır, bu onun çantası.', hint:'çanta = сумка'},
  {topic:'дом и семья', q_ru:'У тебя есть работа?', q_tr:'Senin işin var mı?', a_tr:'Hayır, benim işim yok ama eğitimim var.', hint:'ama = но, eğitim = образование'},
  {topic:'дом и семья', q_ru:'Это твоя квартира?', q_tr:'Bu senin dairen mi?', a_tr:'Hayır, bu kiralık daire.', hint:'kiralık = съёмная'},

  // ═══ ИЗ ФАЙЛА 11: образование и работа ═══
  {topic:'работа', q_ru:'У вас есть образование?', q_tr:'Sizin eğitiminiz var mı?', a_tr:'Evet, benim eğitimim var.', hint:'eğitim = образование'},
  {topic:'работа', q_ru:'Какое у вас образование?', q_tr:'Sizin eğitiminiz ne?', a_tr:'Benim eğitimim hukukçu.', hint:'hukukçu = юрист'},
  {topic:'работа', q_ru:'Какая у вас работа?', q_tr:'Sizin işiniz ne?', a_tr:'Benim işim sürücü.', hint:'iş ne = какая работа, sürücü = водитель'},
  {topic:'работа', q_ru:'У вас официальная работа?', q_tr:'Sizin işiniz resmi mi?', a_tr:'Benim işim resmi değil.', hint:'resmi = официальный'},
  {topic:'работа', q_ru:'Какая у вас профессия?', q_tr:'Sizin mesleğiniz ne?', a_tr:'Benim mesleğim mühendis.', hint:'meslek = профессия, mühendis = инженер'},
  {topic:'работа', q_ru:'Какая у вас зарплата?', q_tr:'Sizin maaşınız ne kadar?', a_tr:'Benim maaşım yüz elli bin ruble.', hint:'maaş = зарплата, ne kadar = сколько'},
  {topic:'работа', q_ru:'У вас высокая зарплата?', q_tr:'Sizin maaşınız yüksek mi?', a_tr:'Benim maaşım düşük.', hint:'yüksek = высокий, düşük = низкий'},
  {topic:'работа', q_ru:'Кто ваш начальник?', q_tr:'Sizin müdürünüz kim?', a_tr:'Benim müdürüm yok.', hint:'müdür = начальник/директор'},
  {topic:'работа', q_ru:'Ваш начальник мужчина или женщина?', q_tr:'Sizin müdürünüz erkek mi yoksa kadın mı?', a_tr:'Benim müdürüm kadın.', hint:'erkek = мужчина, kadın = женщина, yoksa = или'},
  {topic:'работа', q_ru:'У неё высокая зарплата?', q_tr:'Onun maaşı yüksek mi?', a_tr:'Hayır, onun maaşı orta.', hint:'orta = средний'},
  {topic:'работа', q_ru:'У вас много коллег?', q_tr:'Sizin çok meslektaşınız var mı?', a_tr:'Hayır, benim az meslektaşım var.', hint:'meslektaş = коллега, az = мало'},
  {topic:'работа', q_ru:'У вас много клиентов?', q_tr:'Sizin çok müşteriniz var mı?', a_tr:'Hayır, benim az müşterim var.', hint:'müşteri = клиент'},

  // ═══ ИЗ ФАЙЛА 2: опыт, должность ═══
  {topic:'работа', q_ru:'У вас есть опыт?', q_tr:'Sizin tecrübeniz var mı?', a_tr:'Evet, benim tecrübem var.', hint:'tecrübe = опыт'},
  {topic:'работа', q_ru:'Какой у вас опыт?', q_tr:'Sizin tecrübeniz ne?', a_tr:'Benim tecrübem büyük.', hint:'büyük = большой'},
  {topic:'работа', q_ru:'Какая у вас должность?', q_tr:'Sizin pozisyonunuz ne?', a_tr:'Benim pozisyonum muhasebeci.', hint:'pozisyon = должность, muhasebeci = бухгалтер'},
  {topic:'работа', q_ru:'У вас постоянная должность?', q_tr:'Sizin pozisyonunuz daimi mi?', a_tr:'Hayır, benim pozisyonum geçici.', hint:'daimi = постоянный, geçici = временный'},
  {topic:'работа', q_ru:'Какой у вас доход?', q_tr:'Sizin geliriniz ne kadar?', a_tr:'Benim gelirim seksen bin ruble.', hint:'gelir = доход'},
  {topic:'работа', q_ru:'У вас высокий доход?', q_tr:'Sizin geliriniz yüksek mi?', a_tr:'Hayır, benim gelirim orta.', hint:'yüksek = высокий, orta = средний'},
  {topic:'работа', q_ru:'Кто ваш руководитель?', q_tr:'Sizin yöneticiniz kim?', a_tr:'Benim yöneticim müdür.', hint:'yönetici = руководитель'},
  {topic:'работа', q_ru:'Ваш руководитель молодой или пожилой?', q_tr:'Sizin yöneticiniz genç mi yoksa yaşlı mı?', a_tr:'Benim yöneticim genç.', hint:'genç = молодой, yaşlı = пожилой'},
  {topic:'работа', q_ru:'У него большая ответственность?', q_tr:'Onun sorumluluğu büyük mü?', a_tr:'Evet, onun sorumluluğu yüksek.', hint:'sorumluluk = ответственность'},
  {topic:'работа', q_ru:'У вас много проектов?', q_tr:'Sizin çok projeniz var mı?', a_tr:'Hayır, benim az projem var.', hint:'proje = проект, az = мало'},
  {topic:'работа', q_ru:'У вас есть клиенты?', q_tr:'Sizin müşterileriniz var mı?', a_tr:'Evet, benim müşterilerim var.', hint:'müşteri = клиент'},

  // ═══ ИЗ ФАЙЛА 3: деньги, зарплата, команда ═══
  {topic:'работа', q_ru:'У вас есть деньги?', q_tr:'Sizin paranız var mı?', a_tr:'Evet, benim param var.', hint:'para = деньги'},
  {topic:'работа', q_ru:'Сколько у вас денег?', q_tr:'Sizin ne kadar paranız var?', a_tr:'Benim çok param var.', hint:'ne kadar = сколько, çok = много'},
  {topic:'работа', q_ru:'Как вас зовут?', q_tr:'Sizin adınız ne?', a_tr:'Benim adım Yuri.', hint:'ad = имя'},
  {topic:'работа', q_ru:'У вас есть команда?', q_tr:'Sizin ekibiniz var mı?', a_tr:'Evet, benim ekibim var.', hint:'ekip = команда'},
  {topic:'работа', q_ru:'У вас большая команда?', q_tr:'Sizin ekibiniz büyük mü?', a_tr:'Hayır, benim ekibim küçük.', hint:'büyük = большой, küçük = маленький'},
  {topic:'работа', q_ru:'Ваш начальник строгий или спокойный?', q_tr:'Sizin müdürünüz sert mi yoksa sakin mi?', a_tr:'Benim müdürüm sakin.', hint:'sert = строгий, sakin = спокойный'},
  {topic:'работа', q_ru:'Кто ваш друг?', q_tr:'Sizin arkadaşınız kim?', a_tr:'Benim arkadaşım Ali.', hint:'arkadaş = друг'},

  // ═══ ИЗ ФАЙЛА 4: семья, дом, вещи ═══
  {topic:'дом и семья', q_ru:'Как зовут вашего брата?', q_tr:'Erkek kardeşinizin adı ne?', a_tr:'Erkek kardeşimin adı Aleksey.', hint:'erkek kardeş = брат'},
  {topic:'дом и семья', q_ru:'У вас есть сестра?', q_tr:'Sizin kız kardeşiniz var mı?', a_tr:'Evet, kız kardeşimin adı Maria.', hint:'kız kardeş = сестра'},
  {topic:'дом и семья', q_ru:'Мария замужем?', q_tr:'Maria evli mi?', a_tr:'Hayır, kız kardeşim bekar.', hint:'evli = замужем, bekar = не замужем'},
  {topic:'дом и семья', q_ru:'Какая работа у вашего брата?', q_tr:'Erkek kardeşinizin işi ne?', a_tr:'Erkek kardeşim sürücü.', hint:'iş = работа, sürücü = водитель'},
  {topic:'дом и семья', q_ru:'Это ваш дом?', q_tr:'Bu sizin eviniz mi?', a_tr:'Hayır, bu bizim evimiz değil.', hint:'eviniz = ваш дом'},
  {topic:'дом и семья', q_ru:'Чей этот дом?', q_tr:'Bu kimin evi?', a_tr:'Bu bizim arkadaşlarımızın evi.', hint:'kimin = чей, ev = дом'},
  {topic:'дом и семья', q_ru:'У вас есть квартира?', q_tr:'Sizin daireniz var mı?', a_tr:'Evet, bizim Moskova\u2019da dairemiz var.', hint:'daire = квартира'},
  {topic:'дом и семья', q_ru:'У ваших друзей есть дети?', q_tr:'Sizin arkadaşlarınızın çocukları var mı?', a_tr:'Evet, onların üç çocuğu var.', hint:'üç = три, çocuk = ребёнок'},
  {topic:'дом и семья', q_ru:'Это ваш телефон?', q_tr:'Bu sizin telefonunuz mu?', a_tr:'Hayır, benim telefonum siyah, bu ise beyaz.', hint:'siyah = чёрный, beyaz = белый'},
  {topic:'дом и семья', q_ru:'У вас есть родители?', q_tr:'Sizin anne babanız var mı?', a_tr:'Evet, bunlar benim anne babam.', hint:'anne baba = родители'},
  {topic:'дом и семья', q_ru:'У вашего брата есть машина?', q_tr:'Erkek kardeşinizin arabası var mı?', a_tr:'Evet, onun kırmızı bir arabası var.', hint:'kırmızı = красная'},

  // ═══ ИЗ ФАЙЛА 5: сын, жена, образование ═══
  {topic:'дом и семья', q_ru:'Это жена вашего сына?', q_tr:'Bu sizin oğlunuzun karısı mı?', a_tr:'Oğlum evli değil, onun karısı yok.', hint:'oğul = сын, karı = жена'},
  {topic:'дом и семья', q_ru:'У вашего сына есть дети?', q_tr:'Sizin oğlunuzun çocukları var mı?', a_tr:'Evet, bizim oğlumuzun iki çocuğu var.', hint:'iki = два'},
  {topic:'дом и семья', q_ru:'У вас есть образование?', q_tr:'Sizin eğitiminiz var mı?', a_tr:'Benim eğitimim yok, eşimin iki eğitimi var.', hint:'eğitim = образование, eş = супруг'},
  {topic:'дом и семья', q_ru:'Она по образованию медсестра?', q_tr:'Onun eğitimi hemşire mi?', a_tr:'Hayır, onun eğitimi hukukçu, işi hemşire.', hint:'hemşire = медсестра, hukukçu = юрист'},
  {topic:'дом и семья', q_ru:'У вашей жены высокая зарплата?', q_tr:'Eşinizin maaşı yüksek mi?', a_tr:'Benim eşimin maaşı yüksek değil.', hint:'eş = супруг/супруга'},
  {topic:'дом и семья', q_ru:'У вашего сына есть работа?', q_tr:'Sizin oğlunuzun işi var mı?', a_tr:'Evet, o sürücü olarak çalışıyor.', hint:'çalışmak = работать, olarak = как/в качестве'},
  {topic:'дом и семья', q_ru:'Он водитель?', q_tr:'O sürücü mü?', a_tr:'Evet, ve onun maaşı yüksek.', hint:'sürücü = водитель'},
  {topic:'дом и семья', q_ru:'Какого цвета машина вашего сына?', q_tr:'Oğlunuzun arabasının rengi ne?', a_tr:'Oğlumuzun arabasının rengi siyah.', hint:'renk = цвет, siyah = чёрный'},

  // ═══ ИЗ ФАЙЛА 6: родственники ═══
  {topic:'дом и семья', q_ru:'У вас есть старший брат?', q_tr:'Sizin ağabeyiniz var mı?', a_tr:'Hayır, benim sadece küçük erkek kardeşim var.', hint:'ağabey = старший брат, sadece = только'},
  {topic:'дом и семья', q_ru:'Как зовут вашего старшего брата?', q_tr:'Ağabeyinizin adı ne?', a_tr:'Ağabeyimin adı Emre.', hint:'ağabey = старший брат'},
  {topic:'дом и семья', q_ru:'У вашей сестры есть подруга?', q_tr:'Kız kardeşinizin bir arkadaşı var mı?', a_tr:'Evet, en iyi arkadaşının adı Aslı.', hint:'en iyi arkadaş = лучшая подруга'},
  {topic:'дом и семья', q_ru:'Это дом ваших родителей?', q_tr:'Bu sizin anne babanızın evi mi?', a_tr:'Hayır, bu onların arkadaşlarının evi.', hint:'anne baba = родители'},
  {topic:'дом и семья', q_ru:'У ваших родителей есть машина?', q_tr:'Anne babanızın arabası var mı?', a_tr:'Evet, onların kırmızı bir arabası var.', hint:'kırmızı = красная'},
  {topic:'дом и семья', q_ru:'У вашей бабушки есть внуки?', q_tr:'Ninenizin torunları var mı?', a_tr:'Evet, onun beş torunu var.', hint:'nine = бабушка, torun = внук'},
  {topic:'дом и семья', q_ru:'У вашей тёти есть квартира?', q_tr:'Teyzenizin dairesi var mı?', a_tr:'Evet, teyzemin İzmir\u2019de bir dairesi var.', hint:'teyze = тётя'},
  {topic:'дом и семья', q_ru:'У вашей тёти есть работа?', q_tr:'Teyzenizin işi var mı?', a_tr:'Hayır, o emekli.', hint:'emekli = пенсионер'},
  {topic:'дом и семья', q_ru:'Это ребёнок вашей дочери?', q_tr:'Bu sizin kızınızın çocuğu mu?', a_tr:'Hayır, bu onun arkadaşının çocuğu.', hint:'kız = дочь'},
  {topic:'дом и семья', q_ru:'У вашей жены есть брат?', q_tr:'Eşinizin erkek kardeşi var mı?', a_tr:'Evet, onun adı Mustafa.', hint:'erkek kardeş = брат'},

  // ═══ ИЗ ФАЙЛА 12: друзья, машины, гражданство ═══
  {topic:'дом и семья', q_ru:'У тебя есть друзья?', q_tr:'Senin arkadaşların var mı?', a_tr:'Benim arkadaşlarım yok.', hint:'arkadaşlar = друзья'},
  {topic:'дом и семья', q_ru:'Антон не твой друг?', q_tr:'Anton senin arkadaşın değil mi?', a_tr:'Hayır, o benim meslektaşım.', hint:'meslektaş = коллега'},
  {topic:'дом и семья', q_ru:'У него есть жена?', q_tr:'Onun karısı var mı?', a_tr:'Ira onun karısı.', hint:'karı = жена'},
  {topic:'дом и семья', q_ru:'У Иры есть работа?', q_tr:'Ira\u2019nın işi var mı?', a_tr:'Evet, o hukukçu.', hint:'hukukçu = юрист'},
  {topic:'дом и семья', q_ru:'У Антона есть машина?', q_tr:'Anton\u2019un arabası var mı?', a_tr:'Evet, bu onun arabası.', hint:'arabası = его машина'},
  {topic:'дом и семья', q_ru:'Какого цвета машина Антона?', q_tr:'Anton\u2019un arabasının rengi ne?', a_tr:'Onun arabasının rengi gri.', hint:'renk = цвет, gri = серый'},
  {topic:'дом и семья', q_ru:'Какого цвета твоя машина?', q_tr:'Senin arabının rengi ne?', a_tr:'Benim arabam yok.', hint:'arabam yok = у меня нет машины'},
  {topic:'дом и семья', q_ru:'У твоей жены есть машина?', q_tr:'Senin karının arabası var mı?', a_tr:'Benim karımın ehliyeti yok.', hint:'ehliyet = водительские права'},
  {topic:'дом и семья', q_ru:'Это чья машина?', q_tr:'Bu kimin arabası?', a_tr:'Bu benim babamın arabası.', hint:'kimin = чья, babam = мой отец'},
  {topic:'дом и семья', q_ru:'Сколько стоит машина твоего отца?', q_tr:'Babanın arabasının fiyatı ne kadar?', a_tr:'Babamın arabasının fiyatı bir milyon iki yüz bin ruble.', hint:'fiyat = цена'},
  {topic:'дом и семья', q_ru:'Твой отец бизнесмен?', q_tr:'Baban iş adamı mı?', a_tr:'Hayır, o askeri.', hint:'iş adamı = бизнесмен, askeri = военный'},
  {topic:'дом и семья', q_ru:'У твоего брата есть гражданство?', q_tr:'Senin erkek kardeşinin vatandaşlığı var mı?', a_tr:'Benim erkek kardeşimin vatandaşlığı yok.', hint:'vatandaşlık = гражданство'},

  // ═══ ИЗ ФАЙЛА 13: разные вещи ═══
  {topic:'дом и семья', q_ru:'Это валюта?', q_tr:'Bu döviz mi?', a_tr:'Hayır, bu döviz değil.', hint:'döviz = валюта'},
  {topic:'дом и семья', q_ru:'Это фрукты?', q_tr:'Bunlar meyveler mi?', a_tr:'Hayır, bunlar sebzeler.', hint:'sebzeler = овощи'},
  {topic:'дом и семья', q_ru:'Это твой телефон?', q_tr:'Bu senin telefonun mu?', a_tr:'Hayır, bu onun telefonu.', hint:'telefon = телефон'},
  {topic:'дом и семья', q_ru:'Эта комната светлая?', q_tr:'Bu oda ışıklı mı?', a_tr:'Hayır, o karanlık.', hint:'ışıklı = светлый, karanlık = тёмный'},
  {topic:'дом и семья', q_ru:'Это твои тетради?', q_tr:'Bunlar senin defterlerin mi?', a_tr:'Hayır, bunlar onun defterleri.', hint:'defterler = тетради'},
  {topic:'дом и семья', q_ru:'У тебя есть телевизор?', q_tr:'Senin televizyonun var mı?', a_tr:'Evet, benim televizyonum var.', hint:'televizyon = телевизор'},
  {topic:'дом и семья', q_ru:'Это ваши ключи?', q_tr:'Bunlar sizin anahtarlarınız mı?', a_tr:'Evet, bunlar bizim anahtarlarımız.', hint:'anahtarlar = ключи'},
  {topic:'дом и семья', q_ru:'Это его родители?', q_tr:'Bunlar onun anne babası mı?', a_tr:'Hayır, bunlar benim anne babam.', hint:'anne baba = родители'},
  {topic:'дом и семья', q_ru:'Это новый стул?', q_tr:'Bu yeni sandalye mi?', a_tr:'Hayır, o eski.', hint:'yeni = новый, eski = старый'},
  {topic:'дом и семья', q_ru:'Эти сумки тяжёлые?', q_tr:'Bu çantalar ağır mı?', a_tr:'Hayır, onlar hafif.', hint:'ağır = тяжёлый, hafif = лёгкий'},
  {topic:'дом и семья', q_ru:'Это твой паспорт?', q_tr:'Bu senin pasaportun mu?', a_tr:'Hayır, bu benim pasaportum.', hint:'pasaport = паспорт'},
  {topic:'дом и семья', q_ru:'У вас есть книга?', q_tr:'Sizin kitabınız var mı?', a_tr:'Evet, bizim kitabımız var.', hint:'kitap = книга'},
  {topic:'дом и семья', q_ru:'У вас есть турецкая SIM-карта?', q_tr:'Sizin Türk SIM kartınız var mı?', a_tr:'Evet, benim Türk SIM kartım var.', hint:'Türk SIM kart = турецкая SIM-карта'},
];
