...
function renderSentences() {
  ...
  if ($('sent-tr-text')) $('sent-tr-text').textContent = s.tr;
...
const DIALOGS = [
  // Отель
  {topic:'отель', q_ru:'Есть свободный номер?', q_tr:'Bo\u015f odan\u0131z var m\u0131?', a_ru:'Evet, bo\u015f odam\u0131z var', a_tr:'Evet, bo\u015f odam\u0131z var', hint:'боş = свободный, oda = номер'},
  {topic:'отель', q_ru:'На сколько человек?', q_tr:'Ka\u00e7 ki\u015fi i\u00e7in?', a_ru:'\u0130ki ki\u015fi i\u00e7in', a_tr:'\u0130ki ki\u015fi i\u00e7in', hint:'ka\u00e7 = сколько, ki\u015fi = человек'},
  {topic:'отель', q_ru:'Паспорт можно?', q_tr:'Pasaportunuzu alabilir miyim?', a_ru:'Tabii, buyurun', a_tr:'Tabii, buyurun', hint:'pasaport = паспорт, alabilir miyim = могу взять?'},
  {topic:'отель', q_ru:'Бронирование есть?', q_tr:'Rezervasyonunuz var m\u0131?', a_ru:'Evet, rezervasyonum var', a_tr:'Evet, rezervasyonum var', hint:'rezervasyon = бронирование'},
  {topic:'отель', q_ru:'Кахвалты включен?', q_tr:'Kahvalt\u0131 dahil mi?', a_ru:'Evet, kahvalt\u0131 dahil', a_tr:'Evet, kahvalt\u0131 dahil', hint:'kahvalt\u0131 = завтрак, dahil = включено'},
  {topic:'отель', q_ru:'Сколько стоит номер?', q_tr:'Oda fiyat\u0131 ne kadar?', a_ru:'Bir gecelik \u00fc\u00e7 bin lira', a_tr:'Bir gecelik \u00fc\u00e7 bin lira', hint:'fiyat = цена, ne kadar = сколько'},
  {topic:'отель', q_ru:'Всё оплачено?', q_tr:'Her \u015feyi \u00f6dediniz mi?', a_ru:'Evet, her \u015feyi \u00f6dedim', a_tr:'Evet, her \u015feyi \u00f6dedim', hint:'\u00f6demek = оплатить, her \u015fey = всё'},

  // Кафе / Ресторан
  {topic:'кафе', q_ru:'Могу я заказать?', q_tr:'Sipari\u015f edebilir miyim?', a_ru:'Tabii, buyurun', a_tr:'Tabii, buyurun', hint:'sipari\u015f = заказ'},
  {topic:'кафе', q_ru:'Могу попробовать?', q_tr:'Tadabilir miyim?', a_ru:'Tabii, buyurun', a_tr:'Tabii, buyurun', hint:'tatmak = пробовать'},
  {topic:'кафе', q_ru:'Можете принести?', q_tr:'Getirebilir misiniz?', a_ru:'Tabii, hemen getiriyorum', a_tr:'Tabii, hemen getiriyorum', hint:'getirmek = принести'},
  {topic:'кафе', q_ru:'Можете дать?', q_tr:'Verebilir misiniz?', a_ru:'Tabii, buyurun', a_tr:'Tabii, buyurun', hint:'vermek = дать'},
  {topic:'кафе', q_ru:'Могу сесть за этот стол?', q_tr:'Bu masaya oturabilir miyim?', a_ru:'Tabii, oturabilirsiniz', a_tr:'Tabii, oturabilirsiniz', hint:'masa = стол, oturmak = сидеть, -ya дательный'},
  {topic:'кафе', q_ru:'Что будете пить?', q_tr:'Ne i\u00e7eceksiniz?', a_ru:'Bir \u00e7ay l\u00fctfen', a_tr:'Bir \u00e7ay l\u00fctfen', hint:'и\u00e7mek = пить, ne = что'},
  {topic:'кафе', q_ru:'Что порекомендуете?', q_tr:'Ne tavsiye edersiniz?', a_ru:'Bug\u00fcn\u00fcn \u00f6zel yeme\u011fi \u00e7ok g\u00fczel', a_tr:'Bug\u00fcn\u00fcn \u00f6zel yeme\u011fi \u00e7ok g\u00fczel', hint:'tavsiye = рекомендация'},
  {topic:'кафе', q_ru:'Счёт, пожалуйста', q_tr:'Hesap l\u00fctfen', a_ru:'Tabii, hemen getiriyorum', a_tr:'Tabii, hemen getiriyorum', hint:'hesap = счёт'},
  {topic:'кафе', q_ru:'Сколько это стоит?', q_tr:'Bunun fiyat\u0131 ne kadar?', a_ru:'Y\u00fcz elli lira', a_tr:'Y\u00fcz elli lira', hint:'bunun = этого (род.), fiyat = цена'},
  {topic:'кафе', q_ru:'Хочу зелёный чай', q_tr:'Ye\u015fil \u00e7ay istiyorum', a_ru:'Tabii, hemen getiriyorum', a_tr:'Tabii, hemen getiriyorum', hint:'ye\u015fil = зелёный, \u00e7ay = чай'},

  // Аптека / Магазин
  {topic:'магазин', q_ru:'У вас есть такая вещь?', q_tr:'Sizde b\u00f6yle \u015fey var m\u0131?', a_ru:'Evet, var', a_tr:'Evet, var', hint:'sizde = у вас (местный), b\u00f6yle = такой'},
  {topic:'магазин', q_ru:'Сколько стоит лекарство?', q_tr:'Bu ila\u00e7\u0131n fiyat\u0131 ne kadar?', a_ru:'Y\u00fcz lira', a_tr:'Y\u00fcz lira', hint:'ila\u00e7 = лекарство, fiyat = цена (родительный)'},
  {topic:'магазин', q_ru:'Могу купить это?', q_tr:'Bunu alabilir miyim?', a_ru:'Tabii, alabilirsiniz', a_tr:'Tabii, alabilirsiniz', hint:'bunu = это (вин.), almak = купить'},
  {topic:'магазин', q_ru:'Могу оплатить?', q_tr:'\u00d6deyebilir miyim?', a_ru:'Tabii', a_tr:'Tabii', hint:'\u00f6demek = оплатить'},
  {topic:'магазин', q_ru:'Картой можно?', q_tr:'Kartla \u00f6deyebilir miyim?', a_ru:'Evet, kartla \u00f6deyebilirsiniz', a_tr:'Evet, kartla \u00f6deyebilirsiniz', hint:'kartla = картой'},
  {topic:'магазин', q_ru:'Наличными можно?', q_tr:'Nakit \u00f6deyebilir miyim?', a_ru:'Evet, nakit de olur', a_tr:'Evet, nakit de olur', hint:'nakit = наличными'},
  {topic:'магазин', q_ru:'Скидка есть?', q_tr:'\u0130ndirim var m\u0131?', a_ru:'Evet, y\u00fczde yirmi indirim var', a_tr:'Evet, y\u00fczde yirmi indirim var', hint:'indirim = скидка'},
  {topic:'магазин', q_ru:'Я хочу купить такую вещь', q_tr:'Ben b\u00f6yle \u015feyi almak istiyorum', a_ru:'Buyurun, hangi renk istersiniz?', a_tr:'Buyurun, hangi renk istersiniz?', hint:'\u015feyi = вещь (вин.), almak = купить'},
  {topic:'магазин', q_ru:'Пакет нужен?', q_tr:'Po\u015fet ister misiniz?', a_ru:'Evet, bir po\u015fet l\u00fctfen', a_tr:'Evet, bir po\u015fet l\u00fctfen', hint:'po\u015fet = пакет'},
  {topic:'магазин', q_ru:'Чек нужен?', q_tr:'Fi\u015f ister misiniz?', a_ru:'Evet, fi\u015f l\u00fctfen', a_tr:'Evet, fi\u015f l\u00fctfen', hint:'fi\u015f = чек'},

  // Аренда
  {topic:'аренда', q_ru:'Хотите арендовать квартиру?', q_tr:'Daire kiralamak istiyor musunuz?', a_ru:'Evet, daire kiralamak istiyorum', a_tr:'Evet, daire kiralamak istiyorum', hint:'daire = квартира, kiralamak = арендовать'},
  {topic:'аренда', q_ru:'Эту квартиру могу арендовать?', q_tr:'Bu daireyi kiralayabilir miyim?', a_ru:'Evet, kiralayabilirsiniz', a_tr:'Evet, kiralayabilirsiniz', hint:'daireyi = квартиру (вин.)'},
  {topic:'аренда', q_ru:'За 15 тыс. лир могу арендовать?', q_tr:'On be\u015f bin liraya kiralayabilir miyim?', a_ru:'Evet, kiralayabilirsiniz', a_tr:'Evet, kiralayabilirsiniz', hint:'liraya = дат. (за ... лир)'},
  {topic:'аренда', q_ru:'Договор составим?', q_tr:'Kira s\u00f6zle\u015fmesi yapabilir miyiz?', a_ru:'Tabii, yapabiliriz', a_tr:'Tabii, yapabiliriz', hint:'s\u00f6zle\u015fme = договор, yapmak = делать'},
  {topic:'аренда', q_ru:'Квартира в центре?', q_tr:'Daire merkezde mi?', a_ru:'Evet, merkezde', a_tr:'Evet, merkezde', hint:'merkez = центр, -de = местный'},
  {topic:'аренда', q_ru:'Квартира с мебелью?', q_tr:'Daire e\u015fyal\u0131 m\u0131?', a_ru:'Evet, e\u015fyal\u0131', a_tr:'Evet, e\u015fyal\u0131', hint:'e\u015fyal\u0131 = с мебелью'},
  {topic:'аренда', q_ru:'Сколько комнат?', q_tr:'Ka\u00e7 oda?', a_ru:'\u00dc\u00e7 oda bir salon', a_tr:'\u00dc\u00e7 oda bir salon', hint:'oda = комната, salon = гостиная'},

  // Приветствие / Общее
  {topic:'общее', q_ru:'Как дела?', q_tr:'Nas\u0131ls\u0131n\u0131z?', a_ru:'\u0130yiyim, te\u015fekk\u00fcr ederim', a_tr:'\u0130yiyim, te\u015fekk\u00fcr ederim', hint:'nas\u0131l = как'},
  {topic:'общее', q_ru:'Откуда вы?', q_tr:'Nerelisiniz?', a_ru:'Rusyal\u0131y\u0131m', a_tr:'Rusyal\u0131y\u0131m', hint:'nereli = откуда'},
  {topic:'общее', q_ru:'Говорите по-русски?', q_tr:'Rus\u00e7a biliyor musunuz?', a_ru:'Hay\u0131r, T\u00fcrk\u00e7e \u00f6\u011freniyorum', a_tr:'Hay\u0131r, T\u00fcrk\u00e7e \u00f6\u011freniyorum', hint:'Rus\u00e7a = по-русски, bilmek = знать'},
  {topic:'общее', q_ru:'Помогите, пожалуйста', q_tr:'Yard\u0131m edebilir misiniz?', a_ru:'Tabii, nas\u0131l yard\u0131m edebilirim?', a_tr:'Tabii, nas\u0131l yard\u0131m edebilirim?', hint:'yard\u0131m = помощь'},
  {topic:'общее', q_ru:'Где туалет?', q_tr:'Tuvalet nerede?', a_ru:'D\u00fczg\u00fcn gidince solda', a_tr:'D\u00fczg\u00fcn gidince solda', hint:'nerede = где'},
  {topic:'общее', q_ru:'Это сколько стоит?', q_tr:'Bu ne kadar?', a_ru:'Elli lira', a_tr:'Elli lira', hint:'ne kadar = сколько'},
// ═══ ИЗ ФАЙЛА 7: Это дорого (базовые вопросы) ═══
  {topic:'покупки', q_ru:'Это дорого?', q_tr:'Bu pahalı mı?', a_ru:'Hayır, bu pahalı değil.', a_tr:'Hayır, bu pahalı değil.', hint:'pahalı = дорогой, değil = не'},
  {topic:'покупки', q_ru:'Это дёшево?', q_tr:'Bu ucuz mu?', a_ru:'Hayır, bu ucuz değil.', a_tr:'Hayır, bu ucuz değil.', hint:'ucuz = дешёвый'},
  {topic:'покупки', q_ru:'Что это?', q_tr:'Bu ne?', a_ru:'Bu meyveler.', a_tr:'Bu meyveler.', hint:'meyveler = фрукты'},
  {topic:'покупки', q_ru:'Они дорогие?', q_tr:'Onlar pahalı mı?', a_ru:'Hayır, onlar pahalı değil.', a_tr:'Hayır, onlar pahalı değil.', hint:'onlar = они'},
  {topic:'покупки', q_ru:'Это твой товар?', q_tr:'Bu senin malın mı?', a_ru:'Hayır, bu benim malım değil.', a_tr:'Hayır, bu benim malım değil.', hint:'mal = товар, senin = твой'},
  {topic:'покупки', q_ru:'Это его товар?', q_tr:'Bu onun malı mı?', a_ru:'Hayır, bu onun malı değil.', a_tr:'Hayır, bu onun malı değil.', hint:'onun = его/её'},
  {topic:'покупки', q_ru:'Это ваша машина?', q_tr:'Bu sizin arabanız mı?', a_ru:'Hayır, bu bizim arabamız değil.', a_tr:'Hayır, bu bizim arabamız değil.', hint:'sizin = ваш, bizim = наш'},
  {topic:'покупки', q_ru:'У вас есть машина?', q_tr:'Sizin arabanız var mı?', a_ru:'Hayır, bizim arabamız yok.', a_tr:'Hayır, bizim arabamız yok.', hint:'var = есть, yok = нет'},
  {topic:'покупки', q_ru:'У него есть машина?', q_tr:'Onun arabası var mı?', a_ru:'Evet, bu onun arabası.', a_tr:'Evet, bu onun arabası.', hint:'onun arabası = его машина'},
  {topic:'покупки', q_ru:'Его машина дорогая?', q_tr:'Onun arabası pahalı mı?', a_ru:'Hayır, onun arabası ucuz.', a_tr:'Hayır, onun arabası ucuz.', hint:'pahalı = дорогая'},
  {topic:'покупки', q_ru:'У тебя есть квартира?', q_tr:'Senin dairen var mı?', a_ru:'Hayır, benim kiralık dairem var.', a_tr:'Hayır, benim kiralık dairem var.', hint:'kiralık = съёмная'},
  {topic:'покупки', q_ru:'У тебя есть работа?', q_tr:'Senin işin var mı?', a_ru:'Benim işim yok.', a_tr:'Benim işim yok.', hint:'iş = работа, yok = нет'},
  {topic:'покупки', q_ru:'Это ваши документы?', q_tr:'Bu sizin evraklarınız mı?', a_ru:'Bizim evraklarımız yok.', a_tr:'Bizim evraklarımız yok.', hint:'evraklar = документы'},
  {topic:'покупки', q_ru:'Кто ваш муж?', q_tr:'Sizin kocanız kim?', a_ru:'Benim kocam Anton.', a_tr:'Benim kocam Anton.', hint:'koca = муж, kim = кто'},
  {topic:'покупки', q_ru:'Лена ваша жена?', q_tr:'Lena sizin karınız mı?', a_ru:'O benim kız kardeşim.', a_tr:'O benim kız kardeşim.', hint:'kız kardeş = сестра'},

  // ═══ ИЗ ФАЙЛА 9: Добро пожаловать (кафе) ═══
  {topic:'кафе', q_ru:'Добро пожаловать', q_tr:'Hoş geldiniz', a_ru:'Hoş bulduk', a_tr:'Hoş bulduk', hint:'стандартное приветствие в Турции'},
  {topic:'кафе', q_ru:'Вам нужен свободный столик?', q_tr:'Sizde boş masa lazım mı?', a_ru:'Evet, bize boş masa lazım.', a_tr:'Evet, bize boş masa lazım.', hint:'boş = свободный, masa = стол'},
  {topic:'кафе', q_ru:'Насколько человек нужен столик?', q_tr:'Kaç kişilik boş masa lazım?', a_ru:'Bize üç kişilik boş masa lazım.', a_tr:'Bize üç kişilik boş masa lazım.', hint:'kaç kişilik = на сколько человек'},
  {topic:'кафе', q_ru:'Этот столик свободный?', q_tr:'Bu masa boş mu?', a_ru:'Hayır, bu masa boş değil.', a_tr:'Hayır, bu masa boş değil.', hint:'boş = свободный'},
  {topic:'кафе', q_ru:'У вас есть меню?', q_tr:'Sizde menü var mı?', a_ru:'Evet, bir dakika.', a_tr:'Evet, bir dakika.', hint:'bir dakika = одну минуту'},
  {topic:'кафе', q_ru:'Можете дать нам меню?', q_tr:'Bize menü verebilir misiniz?', a_ru:'Tabii, buyurun.', a_tr:'Tabii, buyurun.', hint:'verebilir misiniz = можете дать'},
  {topic:'кафе', q_ru:'Можете дать меню моей супруге?', q_tr:'Eşime menü verebilir misiniz?', a_ru:'Tabii efendim.', a_tr:'Tabii efendim.', hint:'eşim = моя супруга/супруг'},
  {topic:'кафе', q_ru:'У вас есть завтрак?', q_tr:'Sizde kahvaltı var mı?', a_ru:'Evet, kahvaltı var.', a_tr:'Evet, kahvaltı var.', hint:'kahvaltı = завтрак'},
  {topic:'кафе', q_ru:'Сколько у вас стоит завтрак?', q_tr:'Sizde kahvaltı ne kadar?', a_ru:'Yüz elli lira.', a_tr:'Yüz elli lira.', hint:'ne kadar = сколько стоит'},
  {topic:'кафе', q_ru:'Вам нужен завтрак?', q_tr:'Size kahvaltı lazım mı?', a_ru:'Evet, kahvaltı istiyorum.', a_tr:'Evet, kahvaltı istiyorum.', hint:'lazım = нужен'},
  {topic:'кафе', q_ru:'Могу ли я сесть за этот столик?', q_tr:'Bu masaya oturabilir miyim?', a_ru:'Evet, buyurun.', a_tr:'Evet, buyurun.', hint:'oturabilir miyim = могу я сесть'},
  {topic:'кафе', q_ru:'Я хочу заказать это блюдо.', q_tr:'Bu yemeği sipariş etmek istiyorum.', a_ru:'Tabii efendim.', a_tr:'Tabii efendim.', hint:'sipariş etmek = заказать, yemek = блюдо'},
  {topic:'кафе', q_ru:'Я хочу попробовать этот салат.', q_tr:'Bu salatayı tatmak istiyorum.', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'tatmak = попробовать, salata = салат'},
  {topic:'кафе', q_ru:'Мне нравится это блюдо.', q_tr:'Bu yemeği beğeniyorum.', a_ru:'Çok memnun oldum.', a_tr:'Çok memnun oldum.', hint:'beğenmek = нравиться, оценивать'},
  {topic:'кафе', q_ru:'Мне нужно попробовать это.', q_tr:'Bunu tatmam lazım.', a_ru:'Tabii.', a_tr:'Tabii.', hint:'tatmam lazım = мне нужно попробовать'},

  // ═══ ИЗ ФАЙЛА 10: Добро пожаловать (магазин) ═══
  {topic:'магазин', q_ru:'У вас есть такая вещь?', q_tr:'Sizde böyle bir şey var mı?', a_ru:'Evet, var.', a_tr:'Evet, var.', hint:'böyle bir şey = такая вещь'},
  {topic:'магазин', q_ru:'Сколько стоит такая вещь?', q_tr:'Böyle bir şey sizde ne kadar?', a_ru:'Yüz lira.', a_tr:'Yüz lira.', hint:'ne kadar = сколько стоит'},
  {topic:'магазин', q_ru:'Как называется такая вещь?', q_tr:'Sizde böyle bir şeyin adı ne?', a_ru:'Bilmiyorum.', a_tr:'Bilmiyorum.', hint:'adı ne = как называется'},
  {topic:'магазин', q_ru:'Вам нужна такая вещь?', q_tr:'Size böyle bir şey lazım mı?', a_ru:'Evet, lazım.', a_tr:'Evet, lazım.', hint:'lazım = нужен/нужна'},
  {topic:'магазин', q_ru:'Нам такая вещь не нужна.', q_tr:'Bize böyle bir şey lazım değil.', a_ru:'Anladım.', a_tr:'Anladım.', hint:'lazım değil = не нужна'},
  {topic:'магазин', q_ru:'Я хочу такую вещь.', q_tr:'Ben böyle bir şey istiyorum.', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'istiyorum = хочу'},
  {topic:'магазин', q_ru:'У вас есть такое лекарство?', q_tr:'Sizde böyle bir ilaç var mı?', a_ru:'Evet, var.', a_tr:'Evet, var.', hint:'ilaç = лекарство'},
  {topic:'магазин', q_ru:'Сколько стоит такое лекарство?', q_tr:'Böyle bir ilaç sizde ne kadar?', a_ru:'İki yüz lira.', a_tr:'İki yüz lira.', hint:'ne kadar = сколько'},
  {topic:'магазин', q_ru:'Вам нужно такое лекарство?', q_tr:'Size böyle bir ilaç lazım mı?', a_ru:'Evet, lazım.', a_tr:'Evet, lazım.', hint:'lazım = нужно'},

  // ═══ ИЗ ФАЙЛА 14: türkçe böyle bir şey (тур. → рус.) ═══
  {topic:'магазин', q_ru:'Hoş geldiniz.', q_tr:'Добро пожаловать.', a_ru:'Hoş bulduk.', a_tr:'Hoş bulduk.', hint:'ответ на приветствие'},
  {topic:'магазин', q_ru:'Türkçeyi kötü biliyorum, ama biraz konuşabilirim.', q_tr:'Я плохо знаю турецкий, но могу немного говорить.', a_ru:'Anlıyorum.', a_tr:'Anlıyorum.', hint:'kötü biliyorum = плохо знаю'},
  {topic:'магазин', q_ru:'Yavaş konuşabilir misiniz?', q_tr:'Вы можете говорить медленно?', a_ru:'Tabii efendim.', a_tr:'Tabii efendim.', hint:'yavaş = медленно'},
  {topic:'магазин', q_ru:'Soru sorabilir miyim?', q_tr:'Могу я задать вопрос?', a_ru:'Tabii.', a_tr:'Tabii.', hint:'soru sormak = задавать вопрос'},
  {topic:'магазин', q_ru:'Ben sizi anlamıyorum.', q_tr:'Я вас не понимаю.', a_ru:'Özür dilerim.', a_tr:'Özür dilerim.', hint:'anlamıyorum = не понимаю'},
  {topic:'магазин', q_ru:'Sizde böyle bir şey var mı?', q_tr:'У вас есть такая вещь?', a_ru:'Evet, var.', a_tr:'Evet, var.', hint:'böyle bir şey = такая вещь'},
  {topic:'магазин', q_ru:'Sizde böyle bir şeyin fiyatı ne kadar?', q_tr:'Сколько у вас стоит такая вещь?', a_ru:'Yüz lira.', a_tr:'Yüz lira.', hint:'fiyat = цена'},
  {topic:'магазин', q_ru:'Ben böyle bir şey istiyorum.', q_tr:'Я хочу такую вещь.', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'istiyorum = хочу'},
  {topic:'магазин', q_ru:'Sizde böyle bir ilaç var mı?', q_tr:'У вас есть такое лекарство?', a_ru:'Evet, var.', a_tr:'Evet, var.', hint:'ilaç = лекарство'},
  {topic:'магазин', q_ru:'Ben böyle bir ilaç istiyorum.', q_tr:'Я хочу такое лекарство.', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'ilaç = лекарство'},

  // ═══ ИЗ ФАЙЛА 15: купить/оплатить ═══
  {topic:'покупки', q_ru:'Я хочу купить эту.', q_tr:'Bunu satın almak istiyorum.', a_ru:'Buyurun efendim.', a_tr:'Buyurun efendim.', hint:'satın almak = купить, bunu = это (вин.)'},
  {topic:'покупки', q_ru:'Мне нужно купить эту.', q_tr:'Bunu almam lazım.', a_ru:'Tabii.', a_tr:'Tabii.', hint:'almam lazım = мне нужно купить'},
  {topic:'покупки', q_ru:'Я хочу купить эту вещь тебе.', q_tr:'Bu şeyi sana satın almak istiyorum.', a_ru:'Teşekkür ederim.', a_tr:'Teşekkür ederim.', hint:'sana = тебе (дат.)'},
  {topic:'покупки', q_ru:'Я хочу купить одежду.', q_tr:'Kıyafet satın almak istiyorum.', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'kıyafet = одежда'},
  {topic:'покупки', q_ru:'Мне нужно купить эту одежду ей.', q_tr:'Bu kıyafeti ona almam lazım.', a_ru:'Anladım.', a_tr:'Anladım.', hint:'ona = ей (дат.), bu kıyafeti = эту одежду (вин.)'},
  {topic:'покупки', q_ru:'Я хочу оплатить это.', q_tr:'Bunu ödemek istiyorum.', a_ru:'Nakit mi kart mı?', a_tr:'Nakit mi kart mı?', hint:'ödemek = платить'},
  {topic:'покупки', q_ru:'Мне нужно это оплатить.', q_tr:'Bunu ödemem gerekiyor.', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'ödemem gerekiyor = мне нужно оплатить'},

  // ═══ ИЗ ФАЙЛА 16: alabilir miyim / bakabilir miyim ═══
  {topic:'покупки', q_ru:'Могу я это купить?', q_tr:'Bunu alabilir miyim?', a_ru:'Evet, buyurun.', a_tr:'Evet, buyurun.', hint:'alabilir miyim = могу ли я взять/купить'},
  {topic:'покупки', q_ru:'Могу купить эту вещь?', q_tr:'Bu şeyi alabilir miyim?', a_ru:'Tabii.', a_tr:'Tabii.', hint:'bu şeyi = эту вещь (вин.)'},
  {topic:'покупки', q_ru:'Могу взять чек?', q_tr:'Fişi alabilir miyim?', a_ru:'Evet, buyurun.', a_tr:'Evet, buyurun.', hint:'fiş = чек'},
  {topic:'покупки', q_ru:'Могу взять сдачу?', q_tr:'Üstünü alabilir miyim?', a_ru:'Tabii.', a_tr:'Tabii.', hint:'üstü = сдача'},
  {topic:'покупки', q_ru:'За сколько я могу это купить?', q_tr:'Bunu kaça alabilirim?', a_ru:'Yüz elli liraya.', a_tr:'Yüz elli liraya.', hint:'kaça = за сколько'},
  {topic:'покупки', q_ru:'Могу я купить это со скидкой?', q_tr:'Bunu indirimli alabilir miyim?', a_ru:'Hayır, indirim yok.', a_tr:'Hayır, indirim yok.', hint:'indirim = скидка'},
  {topic:'покупки', q_ru:'Могу я это оплатить?', q_tr:'Bunu ödeyebilir miyim?', a_ru:'Evet, buyurun.', a_tr:'Evet, buyurun.', hint:'ödeyebilir miyim = могу ли я оплатить'},
  {topic:'покупки', q_ru:'Могу я оплатить наличными?', q_tr:'Bunu nakit ödeyebilir miyim?', a_ru:'Evet, nakit olur.', a_tr:'Evet, nakit olur.', hint:'nakit = наличные'},
  {topic:'покупки', q_ru:'Могу я оплатить картой?', q_tr:'Bunu kartla ödeyebilir miyim?', a_ru:'Evet, kart geçiyor.', a_tr:'Evet, kart geçiyor.', hint:'kart = карта'},
  {topic:'покупки', q_ru:'Могу я посмотреть на это?', q_tr:'Buna bakabilir miyim?', a_ru:'Tabii, buyurun.', a_tr:'Tabii, buyurun.', hint:'buna = на это (дат.), bakabilir miyim = могу посмотреть'},
  {topic:'покупки', q_ru:'Могу я посмотреть на эту вещь?', q_tr:'Bu şeye bakabilir miyim?', a_ru:'Evet, buyurun.', a_tr:'Evet, buyurun.', hint:'bu şeye = на эту вещь (дат.)'},
  {topic:'покупки', q_ru:'Могу я посмотреть чек?', q_tr:'Fişe bakabilir miyim?', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'fişe = на чек (дат.)'},
  {topic:'покупки', q_ru:'Могу я посмотреть лекарство?', q_tr:'İlaca bakabilir miyim?', a_ru:'Buyurun.', a_tr:'Buyurun.', hint:'ilaca = на лекарство (дат.)'},

  // ═══ ИЗ ФАЙЛА 1: Это дом (притяжательные) ═══
  {topic:'дом и семья', q_ru:'Это дом?', q_tr:'Bu ev mi?', a_ru:'Hayır, burası ev değil.', a_tr:'Hayır, burası ev değil.', hint:'ev = дом, değil = не'},
  {topic:'дом и семья', q_ru:'Это квартира?', q_tr:'Bu daire mi?', a_ru:'Hayır, burası ofis.', a_tr:'Hayır, burası ofis.', hint:'daire = квартира, ofis = офис'},
  {topic:'дом и семья', q_ru:'Это твоя машина?', q_tr:'Bu senin araban mı?', a_ru:'Hayır, bu onun arabası.', a_tr:'Hayır, bu onun arabası.', hint:'senin araban = твоя машина'},
  {topic:'дом и семья', q_ru:'Эта книга интересная?', q_tr:'Bu kitap enteresan mı?', a_ru:'Hayır, o sıkıcı.', a_tr:'Hayır, o sıkıcı.', hint:'enteresan = интересный, sıkıcı = скучный'},
  {topic:'дом и семья', q_ru:'Это твои документы?', q_tr:'Bu senin evrakların mı?', a_ru:'Hayır, bu onun evrakları.', a_tr:'Hayır, bu onun evrakları.', hint:'evraklar = документы'},
  {topic:'дом и семья', q_ru:'У тебя есть гражданство?', q_tr:'Senin vatandaşlığın var mı?', a_ru:'Evet, benim vatandaşlığım var.', a_tr:'Evet, benim vatandaşlığım var.', hint:'vatandaşlık = гражданство'},
  {topic:'дом и семья', q_ru:'Это ваша семья?', q_tr:'Bu sizin aileniz mi?', a_ru:'Evet, bu bizim ailemiz.', a_tr:'Evet, bu bizim ailemiz.', hint:'aile = семья'},
  {topic:'дом и семья', q_ru:'Это его дети?', q_tr:'Bu onun çocukları mı?', a_ru:'Hayır, bu bizim çocuklarımız.', a_tr:'Hayır, bu bizim çocuklarımız.', hint:'çocuklar = дети'},
  {topic:'дом и семья', q_ru:'Это новая одежда?', q_tr:'Bu yeni kıyafet mi?', a_ru:'Hayır, o eski.', a_tr:'Hayır, o eski.', hint:'yeni = новый, eski = старый'},
  {topic:'дом и семья', q_ru:'Эти фрукты дорогие?', q_tr:'Bu meyveler pahalı mı?', a_ru:'Hayır, onlar ucuz.', a_tr:'Hayır, onlar ucuz.', hint:'meyveler = фрукты, ucuz = дешёвые'},
  {topic:'дом и семья', q_ru:'У неё есть муж?', q_tr:'Onun kocası var mı?', a_ru:'Evet, onun kocası Ivan.', a_tr:'Evet, onun kocası Ivan.', hint:'koca = муж'},
  {topic:'дом и семья', q_ru:'Это ваша сумка?', q_tr:'Bu sizin çantanız mı?', a_ru:'Hayır, bu onun çantası.', a_tr:'Hayır, bu onun çantası.', hint:'çanta = сумка'},
  {topic:'дом и семья', q_ru:'У тебя есть работа?', q_tr:'Senin işin var mı?', a_ru:'Hayır, benim işim yok ama eğitimim var.', a_tr:'Hayır, benim işim yok ama eğitimim var.', hint:'ama = но, eğitim = образование'},
  {topic:'дом и семья', q_ru:'Это твоя квартира?', q_tr:'Bu senin dairen mi?', a_ru:'Hayır, bu kiralık daire.', a_tr:'Hayır, bu kiralık daire.', hint:'kiralık = съёмная'},

  // ═══ ИЗ ФАЙЛА 11: образование и работа ═══
  {topic:'работа', q_ru:'У вас есть образование?', q_tr:'Sizin eğitiminiz var mı?', a_ru:'Evet, benim eğitimim var.', a_tr:'Evet, benim eğitimim var.', hint:'eğitim = образование'},
  {topic:'работа', q_ru:'Какое у вас образование?', q_tr:'Sizin eğitiminiz ne?', a_ru:'Benim eğitimim hukukçu.', a_tr:'Benim eğitimim hukukçu.', hint:'hukukçu = юрист'},
  {topic:'работа', q_ru:'Какая у вас работа?', q_tr:'Sizin işiniz ne?', a_ru:'Benim işim sürücü.', a_tr:'Benim işim sürücü.', hint:'iş ne = какая работа, sürücü = водитель'},
  {topic:'работа', q_ru:'У вас официальная работа?', q_tr:'Sizin işiniz resmi mi?', a_ru:'Benim işim resmi değil.', a_tr:'Benim işim resmi değil.', hint:'resmi = официальный'},
  {topic:'работа', q_ru:'Какая у вас профессия?', q_tr:'Sizin mesleğiniz ne?', a_ru:'Benim mesleğim mühendis.', a_tr:'Benim mesleğim mühendis.', hint:'meslek = профессия, mühendis = инженер'},
  {topic:'работа', q_ru:'Какая у вас зарплата?', q_tr:'Sizin maaşınız ne kadar?', a_ru:'Benim maaşım yüz elli bin ruble.', a_tr:'Benim maaşım yüz elli bin ruble.', hint:'maaş = зарплата, ne kadar = сколько'},
  {topic:'работа', q_ru:'У вас высокая зарплата?', q_tr:'Sizin maaşınız yüksek mi?', a_ru:'Benim maaşım düşük.', a_tr:'Benim maaşım düşük.', hint:'yüksek = высокий, düşük = низкий'},
  {topic:'работа', q_ru:'Кто ваш начальник?', q_tr:'Sizin müdürünüz kim?', a_ru:'Benim müdürüm yok.', a_tr:'Benim müdürüm yok.', hint:'müdür = начальник/директор'},
  {topic:'работа', q_ru:'Ваш начальник мужчина или женщина?', q_tr:'Sizin müdürünüz erkek mi yoksa kadın mı?', a_ru:'Benim müdürüm kadın.', a_tr:'Benim müdürüm kadın.', hint:'erkek = мужчина, kadın = женщина, yoksa = или'},
  {topic:'работа', q_ru:'У неё высокая зарплата?', q_tr:'Onun maaşı yüksek mi?', a_ru:'Hayır, onun maaşı orta.', a_tr:'Hayır, onun maaşı orta.', hint:'orta = средний'},
  {topic:'работа', q_ru:'У вас много коллег?', q_tr:'Sizin çok meslektaşınız var mı?', a_ru:'Hayır, benim az meslektaşım var.', a_tr:'Hayır, benim az meslektaşım var.', hint:'meslektaş = коллега, az = мало'},
  ...
  {topic:'дом и семья', q_ru:'У вас есть образование?', q_tr:'Sizin eğitiminiz var mı?', a_ru:'Benim eğitimim yok, eşimin iki eğitimi var.', a_tr:'Benim eğitimim yok, eşimin iki eğitimi var.', hint:'eğitim = образование, eş = супруг'},
